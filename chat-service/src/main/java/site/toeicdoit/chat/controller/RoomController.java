...
public class RoomController {
    ...
    public Mono<ResponseEntity<Messenger>> save(@RequestBody RoomDTO dto) {
        ...
        .flatMap(i -> 
            Mono.just(ResponseEntity.ok(Messenger.builder().message("Create room successfully").state(Boolean.TRUE).data(i).build()))
        )
        ;
    }
